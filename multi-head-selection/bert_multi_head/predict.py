    ...
    def predict(self, input_text):
        ...
        with torch.no_grad():
            ...
            if self.hyper['cell_name'] in ('lstm', 'gru'):
                ...
                o = self.model.encoder(tokens, attention_mask=mask)[0]
            else:
                raise ValueError('unexpected encoder name!')
            ...
            for line in temp_tag:
                line.extend([self.model.bio_vocab['O']] * (tokens.size()[1] - len(line)))
            ...
            predict_spo_selection = self.model.inference(mask, input_text, decoded_tag, selection_logits)
