...
class DuIE_selection_preprocessing(object):
    ...
    def _read_line(self, line):
        ...
        if 'spo_list' in instance:
            ...
            if not self._check_valid(text, spo_list):
                return None
            spo_list = [{'predicate': spo['predicate'], 'object': spo['object'], 'subject': spo['subject']
                        } for spo in spo_list]
        ...
        result = {'text': text, 'spo_list': spo_list, 'bio': bio, 'selection': selection}
    ...
    def spo_to_selection(self, text, spo_list):
        ...
        for triplet in spo_list:
            ...
            selection.append({'subject': subject_pos, 'predicate': relation_pos, 'object': object_pos})
